<template>
  <div class="h-full px-6 overflow-y-auto font-extralight text-center">
    ...
    <p class="pt-2">
      ...
      other minor libraries. The inspiration for the design itself was partly
      borrowed from other websites, but the code and the approach on how to
      build it is entirely mine. I hope you like it and please don't hesitate to
